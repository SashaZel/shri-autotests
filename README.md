...
- Jest
- Playwright
- Минимальное использование test-id
...
npm run test:e2e
```
## Как запустить все тесты со всеми BUG_ID

В CLI  можно запустить BASH-скрипт  

```sh
# будут созданы скриншоты и 11 раз запущены тесты
# 1 раз без багов 10 раз с разными багами
# Внимание! При запуске скрипта при создании скриншотов в консоли возможны ложные ошибки
npm run test-all
```
